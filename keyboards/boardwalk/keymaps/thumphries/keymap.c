...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_ortho_hhkb(
        ...
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    M(4),    KC_LGUI, KC_H,    KC_J,    KC_K,    KC_L,    LT(_FN, KC_SCLN), KC_QUOT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    M(4),    KC_LGUI, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                MO(_NAV), MO(_FN), _______, _______,          _______,  KC_SPC,          KC_LGUI, KC_ENT, KC_LALT, TG(_NAV)
    ),
